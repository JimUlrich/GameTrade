...
namespace GameTrade.Data.Migrations
{
    ...
    [Migration("20170812190801_removegenreid")]
    partial class removegenreid
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("GameTrade.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GameTrade.Models.Condition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GameTrade.Models.Designation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GameTrade.Models.GameGenre", b =>
                {
                    b.Property<int>("GameId");
            ...
            modelBuilder.Entity("GameTrade.Models.GameGenre", b =>
                {
                    b.HasOne("GameTrade.Models.Game", "Game")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GameTrade.Models.ApplicationUser")
                        .WithMany("Claims")
